...
# Internal deployment: only local estimators. AnthropicTokenCount was removed because it
# called api.anthropic.com; CHAR_COUNT needs no network, TIKTOKEN_GPT4O only downloads once.
